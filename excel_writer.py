...
def atualizar_planilha(caminho_planilha: Path, linhas: list[tuple]) -> None:
    """Limpa a aba saldoFAPEU e regrava com os dados atuais da consulta."""
    try:
    ...
    if SHEET_NAME not in workbook.sheetnames:
        raise RuntimeError(f"Aba '{SHEET_NAME}' não encontrada em {caminho_planilha.name}")
